...
exports.verifySignMessageData = exports.parseSignMessageText = exports.createSignMessageText = exports.SignMessageVerificationErrorType = void 0;
var SignMessageVerificationErrorType;
(function (SignMessageVerificationErrorType) {
    SignMessageVerificationErrorType["ADDRESS_MISMATCH"] = "ADDRESS_MISMATCH";
    SignMessageVerificationErrorType["DOMAIN_MISMATCH"] = "DOMAIN_MISMATCH";
    SignMessageVerificationErrorType["CHAIN_ID_MISMATCH"] = "CHAIN_ID_MISMATCH";
    SignMessageVerificationErrorType["ISSUED_TOO_FAR_IN_THE_PAST"] = "ISSUED_TOO_FAR_IN_THE_PAST";
    SignMessageVerificationErrorType["ISSUED_TOO_FAR_IN_THE_FUTURE"] = "ISSUED_TOO_FAR_IN_THE_FUTURE";
    SignMessageVerificationErrorType["INVALID_DATA"] = "INVALID_DATA";
})(SignMessageVerificationErrorType = exports.SignMessageVerificationErrorType || (exports.SignMessageVerificationErrorType = {}));
...
exports.createSignMessageText = createSignMessageText;
/**
...
exports.parseSignMessageText = parseSignMessageText;
/**
...
function verifySignMessageData(data, opts) {
    ...
    try {
        const { expectedAddress, expectedChainIds, issuedAtThreshold, expectedDomains, } = opts;
        const errors = [];
        const now = Date.now();
        ...
        if (issuedAtThreshold !== undefined) {
            ...
            if (Math.abs(iat - now) > issuedAtThreshold) {
                if (iat < now) {
                    errors.push(SignMessageVerificationErrorType.ISSUED_TOO_FAR_IN_THE_PAST);
                }
                else {
                    errors.push(SignMessageVerificationErrorType.ISSUED_TOO_FAR_IN_THE_FUTURE);
                }
            }
        }
        return errors;
...
exports.verifySignMessageData = verifySignMessageData;
function normalizeDomain(domain) {
    return domain.replace(/^www\./, "");
}
//# sourceMappingURL=signMessageData.js.map