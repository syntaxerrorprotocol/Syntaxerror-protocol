export var SignMessageVerificationErrorType;
...
})(SignMessageVerificationErrorType || (SignMessageVerificationErrorType = {}));
 ...
 */
export function createSignMessageText(input) {
 ...
 */
export function parseSignMessageText(text) {
 ...
 */
export function verifySignMessageData(data, opts) {
    if (!data.address ||
        !data.domain ||
        !data.issuedAt ||
        !data.nonce ||
